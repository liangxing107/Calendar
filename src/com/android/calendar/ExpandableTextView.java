...
public class ExpandableTextView extends LinearLayout implements OnClickListener {
    ...
    void init() {
        ...
        if(resources != null){
            mMaxCollapsedLines = resources.getInteger((R.integer.event_info_desc_line_num));
            mExpandDrawable = resources.getDrawable(R.drawable.ic_expand_small_holo_light);
            mCollapseDrawable = resources.getDrawable(R.drawable.ic_collapse_small_holo_light);
        }
    }

...
public class SimpleDayPickerFragment extends ListFragment implements OnScrollListener {
    ...
    protected void setUpHeader() {
        ...
        for (int i = Calendar.SUNDAY; i <= Calendar.SATURDAY; i++) {
            mDayLabels[i - Calendar.SUNDAY] = weekdays[i].toUpperCase(); // chenzhentao add 2012-8-21
            // chenzhentao delete 2012-8-21
...
//                    }
//                }
				Time tempTime = new Time(mSelectedDay);
				tempTime.month = mCurrentMonthDisplayed;
				goTo(tempTime.toMillis(true), false, false, false);
				// goTo(tempTime.toMillis(true), false, false, false, mCurrentMonthDisplayed);
				// mAdapter.updateFocusMonth(mCurrentMonthDisplayed);
            } else {
                mPreviousScrollState = mNewState;
            }

...
//        		(parent.getHeight() + parent.getTop()) / mNumWeeks);
    ...
    protected void onDayTapped(Time day) {
        ...
        day.allDay = false;
        day.normalize(true);
        if(day.year == mSelectedDay.year && day.month == mSelectedDay.month && day.monthDay == mSelectedDay.monthDay) {
         if (mShowAgendaWithMonth && !mIsMiniMonth) {
			...
			mController.sendEvent(mContext, EventType.GO_TO, t, null, t, -1, viewType, extras, null, null);
        }
	}

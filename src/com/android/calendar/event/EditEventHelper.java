...
public class EditEventHelper {
    ...
    public static final String EVENT_STYLE = "event_style";
    ...
    ///M:#Lunar#
    protected static final int EVENT_INDEX_IS_LUNAR = 21;///M:for lunar calendar.
    ...
    public boolean saveEvent(CalendarEventModel model, CalendarEventModel originalModel,
            int modifyWhich, int eventStyle) {
        ...
        values.put(Utils.EVENT_STYLE_TYPE, eventStyle);
    ...
    ContentValues getContentValuesFromModel(CalendarEventModel model) {
        ...
        ///M:#Lunar#
        values.put(Events.IS_LUNAR, model.mIsLunar ? 1:0 );
        return values;
    }

 ...
 */
public class DayFragment extends Fragment implements CalendarController.EventHandler, ViewFactory, OnClickListener {
    /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTv_date = (TextView)v.findViewById(R.id.tv_day_view_date);
        return v;
    }
    ...
    private void goTo(Time goToTime, boolean ignoreTime, boolean animateToday) {
        ...
        mSelectedDay.set(goToTime);
        mTv_date.setText(formatTime(mContext, goToTime));
    }
    ...
    public void eventsChanged() {
        ...
        view = (DayView) mViewSwitcher.getNextView();
        view.clearCachedEvents();
        mTv_date.setText(formatTime(mContext, mSelectedDay));
    }
...
// TODO support select message
    ...
    public static final String formatTime(Context context, Time time){
    	...
    	return DateUtils.formatDateTime(context, time.normalize(false), flags);
    }
	...
	public void onClick(View view) {
		...
		case R.id.btn_arrow_left:
			mSelectedDay.monthDay -= mNumDays; // for viewType week and day
			break;
		...
		boolean debug = false;
		if(debug){
			goTo(mSelectedDay, false, false);
		}else{
			CalendarController calendarController = CalendarController.getInstance(mContext);
			calendarController.sendEvent(mContext, EventType.GO_TO, mSelectedDay, mSelectedDay, -1, ViewType.CURRENT);
		}
	}
}

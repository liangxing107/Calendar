    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row.mType == TYPE_DAY) {
            ...
            if (holder == null) {
                ...
                holder.expand_arrow = (ImageView) agendaDayView.findViewById(R.id.expand_arrow);
                holder.julianDay = row.mDay;
                holder.grayed = false;
            ...
            holder.dateView.setText(dateViewText + dayViewText);

            // Set the background of the view, it is grayed for day that are in the past and today
            if (row.mDay > mTodayJulianDay) { // delete by chenzhentao
            ...
            holder.julianDay = row.mDay;
            itemView.setBackgroundResource(R.color.edit_event_bg_color);
            return itemView;
        } else {
            // Error

...
public class AlertActivity extends Activity implements OnClickListener {
    ...
    private class QueryHandler extends AsyncQueryService {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            LogUtil.i(TAG, "onQueryComplete: cursor = " + cursor + ", count = " + 
            ...
            if (!isFinishing()) {
                ...
                LogUtil.e(TAG, "The Activity is finishing, cancel setting adapter");
                cursor.close();
            }
        }
        ...
        protected void onUpdateComplete(int token, Object cookie, int result) {
            ///M:update the notification after update operation Completed.
            LogUtil.v(TAG, "onUpdateComplete, to update Alert Notification.");
            ///M: using an Async way to update Notification instead of the google way.
            /// @{
            /*
             *AlertService.updateAlertNotification(getApplicationContext());
             */
            Utils.updateEventReminder(mContext);
            /// @}
        }
    }
    ...
    protected void onResume() {
        ...
        if (mCursor == null) {
            LogUtil.i(TAG, "mCursor is null, startting a new async query.");
            ...
            LogUtil.i(TAG, "mCursor exists, perform requery");
            if (!mCursor.requery()) {
                Log.w(TAG, "Cursor#requery() failed.");
                mCursor.close();
                mCursor = null;
                LogUtil.e(TAG, "requery failed, clear and do nothing");
            } else {
                LogUtil.d(TAG, "requery succedded, mCursor is updated");
            }
        }
    }

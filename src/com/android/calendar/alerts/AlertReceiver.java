...
public class AlertReceiver extends BroadcastReceiver {
    ...
    ///M: {
    private static final String EVENT_REMINDER_ACTION = "android.intent.action.EVENT_REMINDER";
    ///@}
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (DELETE_ACTION.equals(action)) {
        ...
        } else if(EVENT_REMINDER_ACTION.equals(action) 
                || Utils.UPDATE_EVENT_REMINDER_ACTION.equals(action)) {
            ...
            Log.i(TAG, "Received other broadcast, Action=" + action);
        }
    }
